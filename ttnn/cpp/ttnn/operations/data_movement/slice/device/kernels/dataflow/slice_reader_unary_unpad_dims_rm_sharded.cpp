...
void kernel_main() {
    ...
    constexpr uint32_t src_stride_bytes = get_compile_time_arg_val(3);
    constexpr uint32_t dst_stride_bytes = get_compile_time_arg_val(4);
    constexpr uint32_t begins_bytes = get_compile_time_arg_val(5);
