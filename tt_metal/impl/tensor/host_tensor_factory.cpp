...
template HostTensor host_tensor_from_span_with_pad_value<int8_t>(
    ttsl::Span<const int8_t>, const TensorSpec&, int8_t);
...
template HostTensor HostTensor::from_span<int8_t>(ttsl::Span<const int8_t>, const TensorSpec&);
...
template HostTensor host_tensor_from_vector_with_pad_value<int8_t>(
    const std::vector<int8_t>&, const TensorSpec&, int8_t);
...
template HostTensor HostTensor::from_vector<int8_t>(const std::vector<int8_t>&, const TensorSpec&);
...
template HostTensor HostTensor::from_vector<int8_t>(std::vector<int8_t>&&, const TensorSpec&);
